...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-toggleable-xs" id="collapseEx">
          ...
          <ul class="nav navbar-nav pull-right">
            ...
            <li class="nav-item">
              <a style="color:#fff" class="nav-link" href="https://stdominiccollege.edu.ph/SDCAHelpdesk/">Helpdesk</a>
            </li>
            <li class="nav-item">
          ...
          <div class="row" id="home">
            ...
            <div class="col-lg-6">
              <div class="description">
                ...
                <br>
                <a class="btn btn-primary btn-lg wow fadeInLeft" style="background-color:transparent; font-family:kalinga; border-color: white; border: solid thin;" data-wow-delay="0.3s" data-toggle="modal" data-target="#myModal">Sign In!</a>
              </div>
            </div>
            <!--/.First column-->
  ...
  <!-- Modal -->
  <div id="myModal" class="modal fade" data-backdrop="static" data-keyboard="false" role="dialog" tabindex="-1" aria-labelledby="myModal">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#myModal2').modal('<?php echo $notfmodal; ?>');
