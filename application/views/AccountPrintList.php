...
<!--//HEADER-->
<div class="container" style=" background-color:#fff; padding:50px" id="Print">


    

<?php if($Account_List->num_rows() != 0): ?>
<table class="table table-striped" style="width:50%">
  <tbody style="text-align:left">
    <tr>
      <th>System:</th>
      <th><u>SDCA HEI Portal</u></th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <th><u><?php echo $reportdata; ?></u></th>
    </tr>
    <tr>
      <th>Number of Accounts:</th>
      <th><u><?php echo $Account_List->num_rows(); ?></u></th>
    </tr>
  </tbody>
</table>
...
<table class="table table-striped" >
  ...
  <tbody>
  <?php $count = 1; ?>
  <?php foreach($Account_List->result_array() as $row): ?>
      <tr>
...
<BR><BR><BR>
<h5><i>*This is a system generated report from St. Dominic College of Asia's HEI Student Portal.<i></h4>
<?php else:?>
<h1>
